...
const AboutUs = () => {
    return (
        <div className="bg-gradient-to-r from-purple-50 to-white min-h-screen px-5 md:px-20 py-16">
            {/* Heading Section */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition duration-300">
                    <h2 className="text-2xl font-semibold text-purple-600 mb-3">Efficiency</h2>
                ...
                {/* Feature 2 */}
                <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition duration-300">
                    <h2 className="text-2xl font-semibold text-purple-600 mb-3">Transparency</h2>
                    <p className="text-gray-600">
                ...
                {/* Feature 3 */}
                <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition duration-300">
                    <h2 className="text-2xl font-semibold text-purple-600 mb-3">Reliability</h2>
                    <p className="text-gray-600">
                ...
                {/* Feature 4 */}
                <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition duration-300">
                    <h2 className="text-2xl font-semibold text-purple-600 mb-3">User-Friendly</h2>
                    <p className="text-gray-600">
